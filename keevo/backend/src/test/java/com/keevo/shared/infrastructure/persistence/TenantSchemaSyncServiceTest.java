...
class TenantSchemaSyncServiceTest {
    ...
    void should_not_recreate_audit_log_when_already_present() throws Exception {
        ...
        when(tablesRs2.next()).thenReturn(true, true, true, true, true, true, true, true, true, true, true, true, true, false); // 13 tables
        when(tablesRs2.getString("table_name")).thenReturn(
                ...
                "day_closures", "stock_transfers", "sync_operations_log");

        when(tablesStmt3.executeQuery()).thenReturn(tablesRs3);
        when(tablesRs3.next()).thenReturn(true, true, true, true, true, true, true, true, true, true, true, true, true, false); // 13 tables
